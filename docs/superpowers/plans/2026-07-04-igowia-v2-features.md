...
console.log('rate-limited list before over-limit:', s.listRateLimitedIps().length === 0);
s.checkAndIncrementRateLimit('5.5.5.5');
console.log('rate-limited list after over-limit:', s.listRateLimitedIps().length === 1 && s.listRateLimitedIps()[0].ip === '5.5.5.5');
